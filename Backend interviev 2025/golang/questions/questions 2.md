...
_Ответ_:
  ...
  ![E:\собес\bdInterview\go\img_2.png](file:///e%3A/%D1%81%D0%BE%D0%B1%D0%B5%D1%81/bdInterview/go/img_2.png)
...
1. Частые операции чтения: Если у вас много операций чтения и относительно немного операций  записи
...
* **sync.Cond**: предоставляет механизм для блокирования горутины, пока не будет выполнено некоторое условие. Не так давно Расс Кокс отменил предложение удалить данный тип в будущей версии Go.
