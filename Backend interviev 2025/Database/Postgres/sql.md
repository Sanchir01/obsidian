![[Pasted image 20250625175325.png]]
...
Это базовые транзакции, которые начинаются с команды BEGIN и завершаются командой COMMIT или ROLLBACK. Все операции между этими командами выполняются как единое целое.
